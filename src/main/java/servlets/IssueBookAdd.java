...
@WebServlet("/servlets.IssueBookAdd")
public class IssueBookAdd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		IssuedBook bean=new IssuedBook(callno,studentid,studentname,studentmobile);
		
		int i=IssuedBookDao.saveIssueBook(bean);
		if(i > 0) {
